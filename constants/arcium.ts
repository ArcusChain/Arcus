...
export const DEFAULT_SIGNING_MESSAGE = new TextEncoder().encode(
        'Arcus Privacy - do NOT sign this message unless you are using an application or integration with Arcus Privacy! Proceed cautiously as this signature will be used to derive sensitive information that can be used to control/transact/decrypt balances and funds from your Arcus Accounts.'
);
