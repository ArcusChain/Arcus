...
const ZK_ARTIFACT_BASE_URL = 'https://arcus-zk-public.s3.eu-central-1.amazonaws.com/uploads';
 ...
 * - Converting snarkjs Groth16 proofs into Arcus's `[A, B, C]` byte-array representation
 *
 * The concrete mapping from Arcus SDK arguments to the Circom input shape is handled in the
