...
export class RelayerForwarder extends ITransactionForwarder<SolanaTransactionSignature> {
         ...
         * discovery service at `https://relayer.arcusprivacy.com` to obtain
        ...
        public static async getRandomRelayerForwarder(): Promise<RelayerForwarder> {
                ...
                try {
                        const response = (await fetch('https://relayer.arcusprivacy.com', {
                                method: 'POST',
                                headers: {
         ...
         *
         * @remarks
         * This method performs a simple GET request to `https://relayer.arcusprivacy.com`.
