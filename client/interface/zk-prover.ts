...
export abstract class IZkProver {
         ...
         * Used for privacy-preserving key registration in the Arcus protocol.
         *
         * @example
         * ```typescript
         ...
         * privacy-preserving token deposits in the Arcus protocol.
         *
         * @example
         * ```typescript
         ...
         * expected commitments. Used for privacy-preserving deposit claims in the Arcus protocol.
         *
         * @example
         * ```typescript
         ...
         * private in the proof. Used for privacy-preserving deposit claims in the Arcus protocol.
         *
         * @example
         * ```typescript
