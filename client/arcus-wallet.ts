...
/**
 * Abstract base class for all Arcus wallet-related errors.
 *
 * @remarks
 * This class provides a foundation for all Arcus wallet errors, ensuring consistent
 * error handling and type safety across wallet operations. All Arcus wallet errors
 * should extend this class.
 *
 * @public
 */
export abstract class ArcusWalletError extends Error {
        /**
         * Creates a new instance of ArcusWalletError.
         *
 ...
 * @public
 */
export class ArcusWalletInitializationError extends ArcusWalletError {
        /**
         * Creates a new instance of ArcusWalletInitializationError.
         *
         ...
         */
        public constructor(message: string, cause?: Error) {
                super(`Failed to initialize Arcus wallet: ${message}`, cause);
        }
}
 ...
 * @public
 */
export class InvalidPurposeCodeError extends ArcusWalletError {
        /**
...
/**
 * Arcus Privacy wallet implementation providing cryptographic operations and transaction signing.
 *
 * @remarks
 * The ArcusWallet class is the main interface for interacting with the Arcus Privacy protocol.
 ...
 *
 * **Key Derivation:**
 * - X25519 keys are derived using KMAC256 with domain separator "Arcus Privacy - X25519 Private Key"
 * - Master viewing key is derived using KMAC128 with domain separator "Arcus Privacy - Master Viewing Key"
 *
 * **Rescue Ciphers:**
...
export class ArcusWallet {
         ...
         *
         * @remarks
         * This 128-bit key is used for compliance and transaction linking in the Arcus protocol.
        ...
        /**
         * Private constructor for creating ArcusWallet instances.
         *
        ...
        /**
         * Creates a new ArcusWallet instance from a signer.
         *
         * @param signer - The signer instance to use for wallet operations
         * @returns A promise resolving to a new ArcusWallet instance
         *
         * @throws {@link ArcusWalletInitializationError} When wallet initialization fails
         * @throws {@link SignerError} When message signing fails during initialization
         *
         * @remarks
         * This factory method initializes a new ArcusWallet by:
         ...
         * ```
         */
        public static async fromSigner(signer: ISigner): Promise<ArcusWallet> {
                try {
                        ...
                        const randomSecretMasterSeed = kmac256(
                                new TextEncoder().encode(
                                        'Arcus Privacy - Random Secret Master Seed'
                                ),
                                masterSignatureSeed
                        );
                        ...
                        throw new ArcusWalletInitializationError(
         ...
         *
         * The domain separator "Arcus Privacy - X25519 Private Key" ensures the derived
         * key is unique to this purpose and prevents key reuse across different contexts.
         *
         * @example
         * ```typescript
         * const { x25519PrivateKey, x25519PublicKey } =
         *   ArcusWallet.createX25519KeypairFromMasterSignatureSeed(signatureSeed);
         * ```
         */
        public static createX25519KeypairFromMasterSignatureSeed(masterSignatureSeed: Uint8Array): {
                ...
                const X25519_DOMAIN_SEPARATOR = new TextEncoder().encode(
                        'Arcus Privacy - X25519 Private Key'
                );
         ...
         *
         * The domain separator "Arcus Privacy - Master Viewing Key" ensures the derived
         * key is unique to this purpose and prevents key reuse across different contexts.
         *
         * @example
         * ```typescript
         * const masterViewingKey =
         *   ArcusWallet.generateMasterViewingKeyFromMasterSignatureSeed(signatureSeed);
         * ```
         */
        public static generateMasterViewingKeyFromMasterSignatureSeed(
                ...
                const MASTER_VIEWING_KEY_DOMAIN_SEPARATOR = new TextEncoder().encode(
                        'Arcus Privacy - Master Viewing Key'
                );
         ...
         * "Arcus Privacy - Master Viewing Key Sha3 Blinding Factor". It is computed from
        ...
        public static generateMasterViewingKeySha3BlindingFactorFromMasterSignatureSeed(
                ...
                const MASTER_VIEWING_KEY_SHA3_BLINDING_FACTOR_DOMAIN_SEPARATOR =
                        new TextEncoder().encode(
                                'Arcus Privacy - Master Viewing Key Sha3 Blinding Factor'
                        );
         ...
         * separator "Arcus Privacy - Master Viewing Key Blinding Factor". It is computed from
         ...
         *   ArcusWallet.generateMasterViewingKeyBlindingFactorFromMasterSignatureSeed(signatureSeed);
         * ```
         */
        public static generateMasterViewingKeyBlindingFactorFromMasterSignatureSeed(
                ...
                const MASTER_VIEWING_KEY_BLINDING_FACTOR_DOMAIN_SEPARATOR =
                        new TextEncoder().encode(
                                'Arcus Privacy - Master Viewing Key Blinding Factor'
                        );
         ...
         *
         * @remarks
         * Purpose codes are used to identify different types of transactions in the Arcus protocol.
         * Supported purposes:
         ...
         * @example
         * ```typescript
         * const purposeCode = ArcusWallet.getPurposeCode('create_spl_deposit_with_hidden_amount');
         * // Returns 2n
         * ```
         */
        ...
        public generateIndividualTransactionViewingKey(
                ...
                const purposeCode = ArcusWallet.getPurposeCode(purpose);
         ...
         * @example
         * ```typescript
         * const message = new TextEncoder().encode('Hello, Arcus!');
         * const signature = await wallet.signMessage(message);
         * ```
         */
         ...
         *   context string (`"Arcus Privacy - Nullifier Master Seed"`).
        ...
        public generateNullifier(index: U256): U128 {
                ...
                const nullifierMasterSeed = kmac128(
                        new TextEncoder().encode('Arcus Privacy - Nullifier Master Seed'),
                        message
                ) as U128BeBytes;
