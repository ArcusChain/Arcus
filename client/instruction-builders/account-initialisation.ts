 ...
 *
 * **Initialization:**
 * This must be called before a user can interact with the Arcus Privacy protocol. The account
 ...
 *
 * **Initialization:**
 * This must be called before a user can interact with tokens of a specific mint in the Arcus Privacy protocol.
