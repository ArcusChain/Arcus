import { ArcusWallet, ArcusWalletError } from '@/client/arcus-wallet';
...
/**
 * Error thrown when adding an Arcus wallet to the client fails.
 *
 * @remarks
 ...
 * @public
 */
export class ArcusWalletAdditionError extends Error {
        /**
         * Creates a new instance of ArcusWalletAdditionError.
         *
...
/**
 * Generic error type for high-level Arcus client operations.
 *
 * @public
 */
export class ArcusClientError extends Error {
...
/**
 * High-level client for interacting with the Arcus Privacy protocol smart contracts.
 *
 * @remarks
 * The `ArcusClient` provides a simplified, user-friendly interface for interacting with
 * the Arcus Privacy protocol without requiring any knowledge of the underlying architecture,
 ...
 *
 * Without a valid connection, the client cannot interact with the Arcus Privacy protocol on-chain.
 *
 * **Key Features:**
 * - **Simplified API**: Interact with Arcus Privacy smart contracts using high-level methods
 ...
 * - **ArcusWallets**: Cryptographic wallets that handle key derivation, signing, and encryption
 ...
 * const client = ArcusClient.create('https://api.mainnet-beta.solana.com');
 *
 * // Create client from Connection instance
 * const connection = new Connection('https://api.mainnet-beta.solana.com');
 * const client = ArcusClient.create(connection);
 *
 ...
 * const client = ArcusClient.create(forwarder);
 *
 * // Access managed components
 * const wallet = client.arcusWallet;
 * const forwarderInstance = client.txForwarder;
 * const connectionForwarder = client.connectionBasedForwarder;
 * ```
 */
export class ArcusClient<T = SolanaTransactionSignature> {
        /**
         * Optional Arcus wallet managed by this client.
         *
         * @remarks
         ...
         */
        public arcusWallet: ArcusWallet | undefined;
         ...
         * `registerAccountForAnonymity`) will throw an {@link ArcusClientError} if it
        ...
        /**
         * Anchor `Program` instance wired to the Arcus IDL, scoped to the connection
         * provided at construction time. All program account fetches/decodes go through it.
         */
        public readonly program: Program<Arcus>;

        private constructor(
                arcusWallet: ArcusWallet | undefined,
                connectionBasedForwarder: ConnectionBasedForwarder,
                program: Program<Arcus>,
                indexer: IIndexer,
                zkProver?: IZkProver
        ) {
                this.arcusWallet = arcusWallet;
         ...
         * will throw an {@link ArcusClientError} if a prover has not been configured.
         */
        ...
        /**
         * Creates an ArcusClient from a ConnectionBasedForwarder instance.
         *
         ...
         * @returns A new ArcusClient instance
         *
         * @remarks
        ...
        /**
         * Creates an ArcusClient from a Solana Connection instance.
         *
        ...
        /**
         * Creates an ArcusClient from an RPC URL.
         *
         ...
         *
         * @remarks
         * This is the simplest way to create an ArcusClient. Just provide an RPC endpoint URL
         ...
         * - Initialize without an Arcus wallet (to be added later via `addArcusWallet`)
         *
         * @example
         * ```typescript
         * // Mainnet
         ...
         *
         * // Devnet
         * const client = ArcusClient.create('https://api.devnet.solana.com');
         *
         * // Custom RPC
         * const client = ArcusClient.create('https://your-rpc-endpoint.com');
         * ```
         */
        public static create(rpcUrl: string, indexerOrSpecifier?: IIndexer | 'aws'): ArcusClient;
        ...
        public static create(
                ...
                const program = new Program<Arcus>(idl as Arcus, provider);

                const resolvedIndexer = ArcusClient.resolveIndexer(indexerOrSpecifier);

                return new ArcusClient(
                        undefined,
        ...
        /**
         * Sets the Arcus wallet on the client from an existing ArcusWallet instance.
         *
         * @param arcusWallet - An existing ArcusWallet instance to set on the client
         * @returns A promise that resolves when the wallet is successfully set
         *
         * @throws {@link ArcusWalletAdditionError} When the wallet is null, undefined, or invalid
         *
         * @remarks
         * Use this overload when you already have a created ArcusWallet instance and want to
         ...
         *
         * **Wallet Management:**
         * Once added, the wallet is stored in the client's `arcusWallet` field and can be
         * accessed for cryptographic operations, transaction signing, and encryption.
         *
         * @example
         * ```typescript
         * // Create wallet separately
         * const wallet = await ArcusWallet.fromSigner(signer);
         *
         * // Set on client
         * await client.setArcusWallet(wallet);
         * ```
         */
        public async setArcusWallet(arcusWallet: ArcusWallet): Promise<void>;

        /**
         * Sets the Arcus wallet on the client by creating it from an ISigner.
         *
         * @param signer - An ISigner instance to create the ArcusWallet from
         * @returns A promise that resolves when the wallet is successfully created and set
         *
         * @throws {@link ArcusWalletAdditionError} When wallet creation fails due to signer errors, key derivation failures, or initialization issues
         *
         * @remarks
         * Use this overload when you have a signer and want the client to automatically create
         * the ArcusWallet for you and associate it with the client. This is the most convenient
         * approach as it handles all wallet initialization internally.
         *
         * **Wallet Creation Process:**
         * The wallet is created using `ArcusWallet.fromSigner`, which:
         ...
         * is unavailable or fails to sign, a `ArcusWalletAdditionError` will be thrown.
         *
         * @example
         * ```typescript
         * // Create wallet from signer directly and set on client
         * await client.setArcusWallet(signer);
         *
         * // Access the created wallet
         * const wallet = client.arcusWallet;
         * ```
         */
        public async setArcusWallet(signer: ISigner): Promise<void>;

        /**
         * Implementation of setArcusWallet that handles all overloads.
         *
         * @internal
         */
        public async setArcusWallet(arcusWalletOrSigner: ArcusWallet | ISigner): Promise<void> {
                try {
                        let wallet: ArcusWallet;

                        if (arcusWalletOrSigner instanceof ArcusWallet) {
                                // Direct ArcusWallet instance
                                if (!arcusWalletOrSigner) {
                                        throw new ArcusWalletAdditionError(
                                                'ArcusWallet instance cannot be null or undefined'
                                        );
                                }
                                wallet = arcusWalletOrSigner;
                        } else {
                                ...
                                try {
                                        wallet = await ArcusWallet.fromSigner(arcusWalletOrSigner);
                                } catch (error) {
                                        if (error instanceof ArcusWalletError) {
                                                throw new ArcusWalletAdditionError(
                                                        `Failed to create ArcusWallet from signer: ${error.message}`,
                                                        error
                                                );
                                        }
                                        throw new ArcusWalletAdditionError(
                                                `Failed to create ArcusWallet from signer: ${error instanceof Error ? error.message : String(error)}`,
                                                error instanceof Error ? error : undefined
                                        );
                                }
                        }

                        this.arcusWallet = wallet;
                } catch (error) {
                        if (error instanceof ArcusWalletAdditionError) {
                                throw error;
                        }
                        throw new ArcusWalletAdditionError(
                                `Failed to add Arcus wallet: ${error instanceof Error ? error.message : String(error)}`,
                                error instanceof Error ? error : undefined
                        );
                }
        }
         ...
         * the Arcus relayer discovery service to obtain a suitable relayer public key.
         *
        ...
        /**
         * Registers the user's Arcus account for confidentiality, with flexible control over
         ...
         *   using the client's Arcus wallet X25519 public key.
         *
         * It then optionally:
         * - Populates fee payer and recent blockhash, and/or
         * - Signs with the client's `arcusWallet`, and/or
         ...
         *   Signs the transaction with the client's `arcusWallet` and sends it via
         *   `connectionBasedForwarder`, returning a `SolanaTransactionSignature`.
         *
         * - **`'forwarder'`**
         *   Signs with the client's `arcusWallet` and forwards via `txForwarder`, returning the
         *   generic type `T`. This is useful when using a relayer or custom forwarding strategy.
         *
         * - **`'signed'`**
         *   Signs with the client's `arcusWallet` and returns the signed `VersionedTransaction`
         ...
         *
         * In all modes, an Arcus wallet **must** be set on the client via {@link setArcusWallet}.
         *
         * @example
         * ```typescript
         ...
         *
         * const client = ArcusClient<ForwardResponse>.create(connection);
         * client.txForwarder = await ArcusClient.getRandomRelayerForwarder();
         * await client.setArcusWallet(signer);
         *
        ...
        public async registerAccountForConfidentiality(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to register account for confidentiality'
                        );
                }
                ...
                // Modes that require signing with the Arcus wallet.
                const signedTransaction =
                        await this.arcusWallet.signTransaction(preparedTransaction);
                ...
                if (mode === 'forwarder') {
                        if (!this.txForwarder) {
                                throw new ArcusClientError(
                                        'No transaction forwarder configured on ArcusClient'
                                );
                        }
        ...
        private async buildRegisterAccountForConfidentialityInstructions(
                ...
                const userPublicKey = await this.arcusWallet.signer.getPublicKey();
                ...
                if (
                        ...
                        throw new ArcusClientError('User account is not active');
                }
                ...
                if (
                        ...
                        instructions.push(
                                await buildConvertUserAccountFromMxeToSharedInstruction(
                                        ...
                                        {
                                                x25519PublicKey:
                                                        this.arcusWallet.arciumX25519PublicKey,
                                                optionalData,
                                        }
                                )
                        );
        ...
        /**
         * Registers the user's Arcus account for anonymity, including master viewing key registration,
        ...
        public async registerAccountForAnonymity(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to register account for anonymity'
                        );
                }
                if (!this.zkProver) {
                        throw new ArcusClientError(
        ...
        /**
         * Registers the user's Arcus account for both confidentiality and anonymity in a single
         * transaction.
         *
         * @remarks
        ...
        public async registerAccountForConfidentialityAndAnonymity(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to register account for confidentiality and anonymity'
                        );
                }
                if (!this.zkProver) {
                        throw new ArcusClientError(
        ...
        private async buildRegisterAccountForAnonymityInstructions(
                ...
                const masterViewingKey = this.arcusWallet.masterViewingKey;
                const masterViewingKeyPoseidonBlindingFactor =
                        this.arcusWallet.masterViewingKeyPoseidonBlindingFactor;
                const masterViewingKeySha3BlindingFactor =
                        this.arcusWallet.masterViewingKeySha3BlindingFactor;
                ...
                const [ciphertexts, nonce] = await this.arcusWallet.rescueCiphers
         ...
         * - Decrypts the encrypted balance using the Arcus wallet's MXE Rescue cipher.
         *
         ...
         *
         * @throws {@link ArcusClientError}
         * - If no Arcus wallet has been configured on the client.
         ...
         * @example
         * ```ts
         * // Assume `client` has been created and configured with an Arcus wallet.
        ...
        public async getEncryptedTokenBalance(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to fetch encrypted token balances'
                        );
                }
        ...
        private async decryptEncryptedTokenAccountBalance(accountData: any): Promise<Amount> {
                ...
                const cipher = this.arcusWallet?.rescueCiphers.get(MXE_ARCIUM_X25519_PUBLIC_KEY);
                if (!cipher) {
                        throw new ArcusClientError(
                                'Rescue cipher for MXE_ARCIUM_X25519_PUBLIC_KEY is not configured on the Arcus wallet'
                        );
                }
        ...
        /**
         * Deposits SOL publicly into the Arcus mixer pool via a relayer, generating the required
         ...
         *   - A random secret via {@link ArcusWallet.generateRandomSecret}
         *   - A nullifier via {@link ArcusWallet.generateNullifier}
         ...
         *   {@link ArcusWallet.generateLinkerHashForDepositsIntoMixerPool}.
         ...
         *
         * - **Default / `'connection'`**
         *   Signs the transaction with the client's `arcusWallet` and sends it directly via
         *   `connectionBasedForwarder`, returning a {@link SolanaTransactionSignature}.
         *
         * - **`'forwarder'`**
         *   Signs the transaction with the client's `arcusWallet` and forwards it via `txForwarder`,
         *   returning the generic type `T`. This is the recommended mode when using a relayer.
         *
         * - **`'signed'`**
         *   Signs with the client's `arcusWallet` and returns the signed {@link VersionedTransaction}
         *   without sending it. Use this when you want to control submission yourself.
         *
         * - **`'prepared'`**
         ...
         * explicit {@link ArcusClientError}s.
         *
         * @throws {@link ArcusClientError}
         * - If no Arcus wallet has been configured on the client.
        ...
        public async depositPubliclyIntoMixerPoolSol(
                ...
                if (opts?.relayerPublicKey) {
                        ...
                        const randomRelayer = await ArcusClient.getRandomRelayerForwarder();
                        resolvedRelayerPublicKey = randomRelayer.relayerPublicKey;
                }

                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to deposit into the mixer pool'
                        );
                }
                if (!this.zkProver) {
                        throw new ArcusClientError(
                ...
                if (!accountExists || !isBitSet(accountStatusByte, FLAG_BIT_FOR_IS_INITIALISED)) {
                        throw new ArcusClientError('User account is not initialised');
                }
                ...
                const randomSecret = this.arcusWallet.generateRandomSecret(index);
                const nullifier = this.arcusWallet.generateNullifier(index);

                const [destinationAddressLo, destinationAddressHi] =
                        breakPublicKeyIntoTwoParts(destinationAddress);

                const feesConfiguration =
                        await ArcusClient.getFeesConfigurationForPublicDepositIntoMixerPoolSol(
                                amount
                        );
                ...
                const innerCommitment = PoseidonHasher.hash([
                        ...
                        nullifier,
                        claimableBalance,
                        this.arcusWallet.masterViewingKey,
                ...
                const linkerHash = this.arcusWallet.generateCreateDepositLinkerHash(
        ...
        /**
         * Deposits SPL tokens publicly into the Arcus mixer pool via a relayer, generating the required
         * zero-knowledge proof and commitment/linker hashes.
         *
        ...
        public async depositPubliclyIntoMixerPoolSpl(
                ...
                const feesConfiguration =
                        await ArcusClient.getFeesConfigurationForPublicDepositIntoMixerPoolSpl(
                                amount,
                                mintAddress
                        );
         ...
         * const fees = await ArcusClient.getFeesConfigurationForPublicDepositIntoMixerPoolSol(amount);
         *
         ...
         * const fees = await ArcusClient.getFeesConfigurationForPublicDepositIntoMixerPoolSpl(
         *   amount,
         *   usdcMintAddress
         * );
         *
        ...
        /**
         * Initialises or updates global program‑level information for the Arcus protocol.
         *
         ...
         *
         * - Uses the client's `ArcusWallet` signer as both the payer and protocol signer.
         * - Fetches a recent blockhash from the underlying `Connection`.
         * - Signs the resulting {@link VersionedTransaction} with the `ArcusWallet`.
         *
         * The method will throw if:
         *
         * - No Arcus wallet has been configured on the client.
        ...
        public async initialiseProgramInformation(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise program information'
                        );
                }

                const signerPublicKey = await this.arcusWallet.signer.getPublicKey();
                ...
                const signedTransaction =
                        await this.arcusWallet.signTransaction(versionedTransaction);
         ...
         * using the client's `ArcusWallet` signer as both:
         *
        ...
        public async initialiseMasterWalletSpecifier(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise the master wallet specifier'
                        );
                }
         ...
         *
         * - Uses the client's `ArcusWallet` signer as both the payer and the protocol signer.
        ...
        public async initialiseWalletSpecifier(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a wallet specifier'
                        );
                }
         ...
         * This helper:
         *
         * - Uses the client's `ArcusWallet` signer as the relayer authority and fee payer.
        ...
        public async initialiseRelayerAccount(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a relayer account'
                        );
                }

                const relayerPublicKey = await this.arcusWallet.signer.getPublicKey();
         ...
         * This helper:
         *
         * - Uses the client's `ArcusWallet` signer as the relayer authority and payer.
        ...
        public async initialiseRelayerFeesAccount(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a relayer fees account'
                        );
                }
         ...
         * This helper:
         *
         * - Uses the client's `ArcusWallet` signer as the payer and protocol signer.
        ...
        public async initialisePublicCommissionFeesPool(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a public commission fees pool'
                        );
                }
        ...
        public async initialiseZkMerkleTree(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a ZK Merkle tree'
                        );
                }
        ...
        public async initialiseMixerPool(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Arcus wallet is required to initialise a mixer pool'
                        );
                }
         ...
         *
         * **Requirements:**
         * - An Arcus wallet must be set on the client via {@link setArcusWallet}
         ...
         * - **`'signed'`** – Returns a {@link VersionedTransaction} signed by the client's Arcus wallet.
         ...
         *
         * @throws {@link ArcusClientError} When:
         * - No Arcus wallet is set on the client
        ...
        public async claimDepositConfidentiallyFromMixerPool(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Cannot claim deposit: Arcus wallet is not set. Call setArcusWallet() first.'
                        );
                }
                ...
                try {
                        ...
                        const arcusEncryptedUserAccountPda = getArciumEncryptedTokenAccountPda(
                                destinationAddress,
                                mintAddress
                        );
                        const arcusEncryptedTokenAccountPda = getArciumEncryptedTokenAccountPda(
                                destinationAddress,
                                mintAddress
                        );
                        ...
                        // Fetch account data
                        const [
                                arcusEncryptedUserAccountRawData,
                                arcusEncryptedTokenAccountRawData,
                        ] = await this.connectionBasedForwarder.connection.getMultipleAccountsInfo([
                                arcusEncryptedUserAccountPda,
                                arcusEncryptedTokenAccountPda,
                        ]);

                        // Handle null accounts - decode if exists, otherwise use default status
                        let arcusEncryptedUserAccountData: Awaited<
                                ReturnType<
                                        typeof this.program.account.arciumEncryptedUserAccount.fetch
                                >
                        >;
                        let arcusEncryptedUserAccountStatusByte: number;

                        if (arcusEncryptedUserAccountRawData) {
                                try {
                                        arcusEncryptedUserAccountData =
                                                this.program.coder.accounts.decode(
                                                        'ArciumEncryptedUserAccount',
                                                        arcusEncryptedUserAccountRawData.data
                                                );
                                        arcusEncryptedUserAccountStatusByte =
                                                arcusEncryptedUserAccountData.status[0] ?? 0;
                                } catch (error) {
                                        throw new ArcusClientError(
                                ...
                                arcusEncryptedUserAccountStatusByte =
                                        ArcusClient.getDefaultInitializedUserAccountStatus()[0] ??
                                        0;
                        }

                        let arcusEncryptedTokenAccountData: Awaited<
                                ReturnType<
                                        typeof this.program.account.arciumEncryptedTokenAccount.fetch
                                >
                        >;
                        let arcusEncryptedTokenAccountStatusByte: number;

                        if (arcusEncryptedTokenAccountRawData) {
                                try {
                                        arcusEncryptedTokenAccountData =
                                                this.program.coder.accounts.decode(
                                                        'ArciumEncryptedTokenAccount',
                                                        arcusEncryptedTokenAccountRawData.data
                                                );
                                        arcusEncryptedTokenAccountStatusByte =
                                                arcusEncryptedTokenAccountData.status[0] ?? 0;
                                } catch (error) {
                                        throw new ArcusClientError(
                                ...
                                // Account doesn't exist - use default status for initialized account
                                arcusEncryptedTokenAccountStatusByte =
                                        ArcusClient.getDefaultInitializedTokenAccountStatus()[0] ??
                                        0;
                        }
                        ...
                        const randomSecret = this.arcusWallet.generateRandomSecret(generationIndex);
                        if (!randomSecret) {
                                throw new ArcusClientError(
                        ...
                        const nullifier = this.arcusWallet.generateNullifier(generationIndex);
                        if (!nullifier) {
                                throw new ArcusClientError(
                        ...
                        const feesConfiguration =
                                await ArcusClient.getFeesConfigurationForClaimDepositConfidentiallyFromMixerPool(
                                        mintAddress,
                                        claimableBalance
                                );

                        // Generate linker hash
                        const linkerHash = this.arcusWallet.generateClaimDepositLinkerHash(
                        ...
                        if (!isTokenAccountInitialized) {
                                ...
                                if (
                                        ...
                                        throw new ArcusClientError('Token account is not active');
                                }
                        }
                        ...
                        if (mode === 'signed') {
                                try {
                                        ...
                                        return await this.arcusWallet.signTransaction(
                                                transactionToSign
                                        );
                                } catch (error) {
                                        throw new ArcusClientError(
                        ...
                        if (error instanceof ArcusClientError) {
                                throw error;
                        }
                        throw new ArcusClientError(
        ...
        public async transferConfidentially(
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Cannot transfer confidentially: Arcus wallet is not set. Call setArcusWallet() first.'
                        );
                }
                ...
                if (!resolvedRelayerPublicKey) {
                        throw new ArcusClientError('Unable to resolve relayer public key');
                }

                const senderPublicKey = await this.arcusWallet.signer.getPublicKey();
                if (!senderPublicKey) {
                        throw new ArcusClientError(
                ...
                const rescueCipher = this.arcusWallet.rescueCiphers.get(
                        MXE_ARCIUM_X25519_PUBLIC_KEY
                );
                if (!rescueCipher) {
                        throw new ArcusClientError(
                ...
                if (!senderArciumEncryptedUserAccountRawData) {
                        throw new ArcusClientError('Sender user account does not exist');
                }
                if (!senderArciumEncryptedTokenAccountRawData) {
                        throw new ArcusClientError('Sender token account does not exist');
                }
                ...
                if (
                        ...
                        throw new ArcusClientError('Sender user account is not active');
                }
                if (
                        isBitSet(
                                senderArciumEncryptedUserAccount.status[0] ?? 0,
                ...
                if (
                        ...
                        throw new ArcusClientError('Sender token account is not active');
                }
                if (
                        isBitSet(
                                senderArciumEncryptedTokenAccount.status[0] ?? 0,
                ...
                if (
                        ...
                        throw new ArcusClientError('Sender user account requires SOL deposit');
                }
                ...
                if (!isReceiverUserAccountInitialized) {
                        ...
                        receiverArciumEncryptedUserAccountStatusByte =
                                ArcusClient.getDefaultInitializedUserAccountStatus()[0] ?? 0;
                } else if (
                        !isBitSet(
                                receiverArciumEncryptedUserAccountStatusByte,
                                ARCIUM_ENCRYPTED_USER_ACCOUNT_FLAG_BIT_FOR_IS_ACTIVE
                        ...
                        throw new ArcusClientError('Receiver user account is not active');
                }
                ...
                if (!isReceiverTokenAccountInitialized) {
                        ...
                        receiverArciumEncryptedTokenAccountStatusByte =
                                ArcusClient.getDefaultInitializedTokenAccountStatus()[0] ?? 0;
                } else if (
                        !isBitSet(
                                receiverArciumEncryptedTokenAccountStatusByte,
                                ARCIUM_ENCRYPTED_TOKEN_ACCOUNT_FLAG_BIT_FOR_IS_ACTIVE
                        ...
                        throw new ArcusClientError('Receiver token account is not active');
                }
                ...
                try {
                        ...
                        const signedTransaction =
                                await this.arcusWallet.signTransaction(transactionToSign);
        ...
        > {
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Cannot deposit confidentially: Arcus wallet is not set. Call setArcusWallet() first.'
                        );
                }
                ...
                if (!userAccountRawData) {
                        throw new ArcusClientError('User account does not exist');
                }
                if (!userTokenAccountRawData) {
                        throw new ArcusClientError('Token account does not exist');
                }
                ...
                if (
                        ...
                        throw new ArcusClientError('User account requires SOL deposit');
                }
                ...
                if (
                        ...
                        throw new ArcusClientError('Token account is not initialised');
                }
                ...
                const randomSecret = this.arcusWallet.generateRandomSecret(resolvedIndex);
                if (!randomSecret) {
                        throw new ArcusClientError(
                                'Failed to generate random secret. The wallet may not be properly initialized.'
                        );
                ...
                const nullifier = this.arcusWallet.generateNullifier(resolvedIndex);
                if (!nullifier) {
                        throw new ArcusClientError(
                                'Failed to generate nullifier. The wallet may not be properly initialized.'
                        );
                ...
                const linkerAddressHash = this.arcusWallet.generateCreateDepositLinkerHash(
                ...
                const arciumSignerPublicKey = await this.arcusWallet.signer.getPublicKey();
        ...
        /**
         * Deposits SPL tokens confidentially into the Arcus mixer pool using encrypted amounts and zero-knowledge proofs.
         *
         * @remarks
         ...
         * confidentially into the Arcus mixer pool. Internally delegates to
        ...
        public async claimPubliclyFromMixerPoolSol(
                ...
                const nullifier = this.arcusWallet!.generateNullifier(
                        claimDepositArtifacts.generationIndex
                );
                const nullifierHash = PoseidonHasher.hash([nullifier]);

                const randomSecret = this.arcusWallet!.generateRandomSecret(
                        claimDepositArtifacts.generationIndex
                );
         ...
         *
         * @throws {@link ArcusClientError} Always for now, until the configuration source exists.
         */
         ...
         *    domain separator "Arcus Privacy - Ephemeral Keypair Seed"
         ...
         *
         * @throws {@link ArcusClientError} When:
         * - No Arcus wallet is set on the client (`arcusWallet` is undefined)
        ...
        public generateEphemeralKeypair(index: U256): Keypair {
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Cannot generate ephemeral keypair: Arcus wallet is not set. Call setArcusWallet() first.'
                        );
                }
                ...
                try {
                        const domainSeparatedSeed = kmac256(
                                new TextEncoder().encode('Arcus Privacy - Ephemeral Keypair Seed'),
         ...
         * KMAC256-based key derivation process:
         * 1. First, it derives a domain-separated seed from the master viewing key using the
         *    domain separator "Arcus Privacy - Ephemeral Arcium X25519 Public Key Seed"
        ...
        public generateEphemeralArciumX25519PublicKey(index: U256): {
                ...
                if (!this.arcusWallet) {
                        throw new ArcusClientError(
                                'Cannot generate ephemeral X25519 key pair: Arcus wallet is not set. Call setArcusWallet() first.'
                        );
                }
                ...
                try {
                        const domainSeparateSeed = kmac256(
                                new TextEncoder().encode(
                                        'Arcus Privacy - Ephemeral Arcium X25519 Public Key Seed'
                                ),
                                convertU128ToLeBytes(masterViewingKey)
                        );
